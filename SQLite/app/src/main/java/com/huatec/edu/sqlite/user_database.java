...
public class user_database extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String sql="create table user(id integer primary key autoincrement,username varchar(20),password varchar(20),sex varchar(20),age integer)";
    ...
    //添加数据
    public void adddata(SQLiteDatabase sqLiteDatabase,String username,String password,String sex,int age){
    ...
    //更新数据
    public void update(SQLiteDatabase sqLiteDatabase,int id,String username,String password,String sex,int age){
        //创建一个ContentValues对象
        ContentValues values=new ContentValues();
        //以键值对的形式插入
        values.put("username",username);
